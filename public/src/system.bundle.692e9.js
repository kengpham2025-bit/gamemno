!(function () {
  ...
  function b(t, n, r) {
    ...
    m && Object.defineProperty(s, m, { value: "Module" });
    ...
    [].forEach.call(document.querySelectorAll("script"), function (n) {
      if (!n.sp)
        if ("systemjs-module" === n.type) {
          ...
          System.import(
            "import:" === n.src.slice(0, 7) ? n.src.slice(7) : f(n.src, t)
          ).catch(function (e) {
          ...
          n.sp = !0;
          var r = n.src
            ? fetch(n.src, { integrity: n.integrity })
                .then(function (e) {
  ...
  if (
    ...
    i && (I(), window.addEventListener("DOMContentLoaded", I)),
    i)
  ) {
  ...
  (w.instantiate = function (e, t) {
    ...
    (function (e) {
      var t,
        n,
        r,
        i = e.System.constructor.prototype;
      var o = i.import;
      i.import = function (i, s) {
        return (
          (function () {
            for (var i in ((t = n = void 0), e))
              a(i) || (t ? n || (n = i) : (t = i), (r = i));
          })(),
          o.call(this, i, s)
        );
      ...
      i.getRegister = function () {
        ...
        return [
          ...
          function (e) {
            return {
              execute: function () {
                e(o), e({ default: o, __useDefault: !0 });
              },
            };
          },
        ];
      ...
      function a(t) {
        return (
          !e.hasOwnProperty(t) ||
          (!isNaN(t) && t < e.length) ||
          (c && e[t] && "undefined" != typeof window && e[t].parent === window)
        );
      }
    ...
    (w.set = function (e, t) {
      ...
      k && "Module" === t[k]
        ...
        : ((n = Object.assign(Object.create(null), t)),
          k && Object.defineProperty(n, k, { value: "Module" }));
      ...
      return (
        !i.e &&
        !i.E &&
        (Object.assign(i, { n: n, I: void 0, L: void 0, C: r }), n)
      );
    }),
    (w.has = function (e) {
      return !!this[g][e];
