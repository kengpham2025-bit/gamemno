      ...
      })(
        {
          ...
          9: [
            function (t, r, e) {
              ...
              (n.prototype.init = function () {
                var t = this.options;
                return (
                  t && t.uint8array && (this.bufferish = c.Uint8Array), this
                );
              }),
                (e.preset = a({
                  preset: !0,
          ...
          23: [
            function (t, r, e) {
              ...
              function f(t, r) {
                for (
                  var e = new Array(r), n = t.codec.decode, i = 0;
                  i < r;
                  i++
                )
                  e[i] = n(t);
            ...
            function (t, r, e) {
              function n(t) {
                ...
                function w(t, r) {
                  ...
                  return (
                    e && (r = e(r)), r instanceof l ? U(t, r) : void D(t, r)
                  );
                }
              ...
              (function (r) {
                ...
                (Buffer.prototype.slice = function (t, r) {
                  ...
                  (Buffer.prototype.readUInt16LE = function (t, r) {
                    return (
                      r || C(t, 2, this.length), this[t] | (this[t + 1] << 8)
                    );
                  }),
                  (Buffer.prototype.readUInt16BE = function (t, r) {
                    return (
                      r || C(t, 2, this.length), (this[t] << 8) | this[t + 1]
                    );
                  }),
                  ...
                  (Buffer.prototype.readFloatLE = function (t, r) {
                    return (
                      r || C(t, 4, this.length), K.read(this, t, !0, 23, 4)
                    );
                  }),
                  (Buffer.prototype.readFloatBE = function (t, r) {
                    return (
                      r || C(t, 4, this.length), K.read(this, t, !1, 23, 4)
                    );
                  }),
                  (Buffer.prototype.readDoubleLE = function (t, r) {
                    return (
                      r || C(t, 8, this.length), K.read(this, t, !0, 52, 8)
                    );
                  }),
                  (Buffer.prototype.readDoubleBE = function (t, r) {
                    return (
                      r || C(t, 8, this.length), K.read(this, t, !1, 52, 8)
                    );
                  }),
