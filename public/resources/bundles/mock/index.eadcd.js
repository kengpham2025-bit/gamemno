System.register("chunks:///_virtual/appConfig-debug.ts", ["cc"], function (t) {
  "use strict";
  var e, n;
  return {
    setters: [
      function (t) {
        (e = t.cclegacy), (n = t.log);
      },
    ],
    execute: function () {
      e._RF.push({}, "3eb38TSPwpB+YVQOjSFXXkk", "appConfig-debug", void 0),
        n("VERSION GAME", "1.0.0");
      t("urlConstant", {});
      e._RF.pop();
    },
  };
...
System.register("chunks:///_virtual/appConfig.ts", ["cc"], function (n) {
  "use strict";
  var e, t;
  return {
    setters: [
      function (n) {
        (e = n.cclegacy), (t = n.log);
      },
    ],
    execute: function () {
      e._RF.push({}, "35db3rheKJAzKJGXUGOJV4B", "appConfig", void 0),
        t("VERSION GAME", "1.0.0");
      n("urlConstant", {
        API_URL: "aHV2c3c/KShpeWMldGh7Znd+dXw6fHhxdzZsKTM=",
        SOCKET_URL: "d3JxOSsqcXRvOTgldGh7Znd+dXw6fHhxdw==",
        IPMaster2: "d3JxOSsqa2Z7fW95InVrenl2fXR7O395fnY1",
        USER_TOKEN: "user_token",
        URL_TOKEN: "token",
        IS_DECODE: !0,
        REMOTE_CONFIG_URL_FULL: "./config/appConfig_sls_v2_789.json",
      });
      e._RF.pop();
    },
  };
...
System.register(
  "chunks:///_virtual/mock",
  ["./appConfig-debug.ts", "./appConfig.ts", "./mock.ts"],
  function () {
    "use strict";
...
System.register("chunks:///_virtual/mock.ts", ["cc"], function (b) {
  "use strict";
  var e;
  return {
    setters: [
    ...
    execute: function () {
      e._RF.push({}, "b2d9b/hI7RNZb1ECwlct7T9", "mock", void 0);
      b("mock", {
        9999: "spinNoWin",
        9998: "spinMiniGame",
        5999: "spinWin",
...
(function (r) {
  r("virtual:///prerequisite-imports/mock", "chunks:///_virtual/mock");
})(function (mid, cid) {
